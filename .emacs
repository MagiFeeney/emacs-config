...
(custom-set-variables
 ...
 '(package-selected-packages
   '(flycheck magit auctex doom-themes timu-spacegrey-theme kaolin-themes cyberpunk-theme which-key helm treemacs ess spacemacs-theme company auto-complete netease-music multiple-cursors ##))
