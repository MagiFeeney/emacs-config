...
(custom-set-variables
 ...
 '(package-selected-packages
   '(cape yasnippet-snippets embark-consult consult embark marginalia orderless vertico corfu meow all-the-icons doom-modeline yasnippet ace-window pdf-tools avy counsel swiper ivy use-package org-roam expand-region flycheck magit auctex doom-themes timu-spacegrey-theme which-key ess company auto-complete multiple-cursors ##))
...
;; delete selected region automatically
