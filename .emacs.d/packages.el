...
(defhydra hydra-movement (global-map "M-g m")
  ("n" next-line "down" :column "Vertical")
  ("p" previous-line "up")
  ("f" forward-char "forward" :column "Horizontal")
...
(defhydra hydra-movement-boldly (global-map "M-g m b")
  ("n" forward-paragraph "down" :column "Vertical")
  ("p" backward-paragraph "up")
  ("f" forward-word "forward" :column "Horizontal")
