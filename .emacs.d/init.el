...
(custom-set-variables
 ...
 '(package-selected-packages
   '(symbol-overlay org-ref ivy-bibtex ebib vterm yasnippet-snippets consult marginalia orderless vertico corfu meow yasnippet ace-window pdf-tools use-package org-roam expand-region magit auctex doom-themes multiple-cursors ##))
 '(pdf-view-midnight-colors '("#655370" . "#fbf8ef"))
 '(send-mail-function 'mailclient-send-it)
 '(tool-bar-mode nil)
 '(global-hl-line-mode t)
 '(save-place-mode t) ;; retain last point for visited files when revisiting
 '(make-backup-files nil) ;; no autosave #file#
 )
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :extend nil :stipple nil :background "#292A30" :foreground "#FFFFFF" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight bold :height 120 :width normal :foundry "JB" :family "JetBrains Mono"))))
